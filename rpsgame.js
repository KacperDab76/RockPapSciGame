...
// function for lab 8 
// uses series of if...else if to find a winner 
function choice(n){
        // 1 - Rock
        // 2 - paper
        // 3 - scissors
...
// it is used by both choice(n) and game() functions
...
// function used in lab 9 
// uses while loop because it supposed to stop when user wins
// but also allows to play only 3 times 
function game () {
